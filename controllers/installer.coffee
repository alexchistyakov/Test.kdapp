class TestInstallerController extends KDController

  constructor:(options = {}, data)->

    { testInstallerController } = KD.singletons
    return testInstallerController if testInstallerController

    super options, data

    @kiteHelper = new KiteHelper
    @kiteHelper.ready @bound "configureWatcher"
    @registerSingleton "testInstallerController", this, yes
